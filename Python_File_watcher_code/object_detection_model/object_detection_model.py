...
CAR_MODEL_PATH = "/home/parkinbial_pgs/srv/object_detection_model/models/yolov8m.pt"
PLATE_MODEL_PATH = "/home/parkinbial_pgs/srv/object_detection_model/models/best.pt"
API_URL = "http://192.168.10.5/api/update-parking-slots"
# GET_API_URL = "http://192.168.10.5/api/prod-bluetooth-lamp-pyapi"
...
async def send_results_to_api(results):
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            # 2 GET request (runs after POST success)
